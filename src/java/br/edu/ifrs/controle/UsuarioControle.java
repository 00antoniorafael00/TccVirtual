...
public class UsuarioControle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(op.equals("AUTENTICAR")) autenticar(request, response);
    ...
    protected void autenticar(HttpServletRequest request, HttpServletResponse response)
        ...
        try {           
            ...
            usuario = new Usuario();
            usuario = usuario.autenticar(matricula, senha);     // # verificar existencia b
            
            if (usuario != null) {      // coloca o usuario como atributo da sessao
                ...
                request.setAttribute("msg_erro", "Matrícula ou senha inválidas!!!!");
                RequestDispatcher dispatcher = 
